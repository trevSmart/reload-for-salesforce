...
export default class ReloadWorkbench extends LightningElement {
    ...
    stagingColumns = [
        ...
        { label: 'Source Reference', fieldName: 'Source_Reference__c', type: 'text' }
    ];
    ...
    fieldColumns = [
        ...
        { label: 'Value', fieldName: 'Field_Value__c', type: 'text', wrapText: true },
    ...
    wiredBatches(result) {
        ...
        if (result.data) {
            ...
            if (this.selectedBatchId) {
                const stillExists = this.batches.some((row) => row.Id === this.selectedBatchId);
                if (!stillExists) {
    ...
    handleBatchSelection(event) {
        ...
        this.selectedBatchId = selectedRows && selectedRows.length ? selectedRows[0].Id : undefined;
        this.selectedStagingId = undefined;
        this.fieldValues = undefined;
        if (this.selectedBatchId) {
    ...
    handleStagingSelection(event) {
        const selectedRows = event.detail.selectedRows;
        this.selectedStagingId = selectedRows && selectedRows.length ? selectedRows[0].Id : undefined;
